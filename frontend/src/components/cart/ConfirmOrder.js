      ...
      <Fragment>
        ...
        <div className="row d-flex justify-content-between">
          <div className="col-12 col-lg-8 mt-5 order-confirm">
            ...
            <p className="mb-4">
              <b>Địa chỉ:</b>{`${shippingInfo.address}, ${shippingInfo.city}, ${shippingInfo.postalCode}, ${shippingInfo.country}`}
            </p>

            <hr />
            <h4 className="mt-4">Các món:</h4>
          ...
          <div className="col-12 col-lg-3 my-4">
            <div id="order_summary">
              ...
              <hr />
              <p>
                Tổng phần: <span className="order-summary-values">${itemsPrice}</span>
              </p>
              <p>
                Tổng phí vận chuyển: <span className="order-summary-values">${shippingPrice}</span>
              </p>
              <p>
              ...
              <p>
                Tổng tiền sản phẩm: <span className="order-summary-values">${totalPrice}</span>
              </p>
