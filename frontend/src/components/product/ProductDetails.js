        ...
        <Fragment>
          ...
          <div className="row f-flex justify-content-around">
            ...
            <div className="col-12 col-lg-5 mt-5">
              ...
              <p>
                Trạng thái: <span id="stock_status" className={product.stock > 0 ? 'greenColor' : 'redColor'}>{product.stock > 0 ? 'Còn hàng' : 'Hết hàng' }</span>
              </p>
              ...
              <p id="product_seller mb-3">
                Sản xuất tại: <strong>{product.seller}</strong>
              </p>
              ...
              :
                <div className='alert alert-danger mt-5' type='alert'> Đăng nhập để đánh giá. </div>
              }
